...
function MainPageSunny() {
    return (
        <div>
            <h1>Main Page - Sunny</h1>
            <button onClick={() => window.location.href = '/welcome'}>Go to Welcome Page</button>
            <button onClick={() => window.location.href = '/clothes'}>Go to Clothes Page</button>
            <button onClick={() => window.location.href = '/hydration'}>Go to Hydration Page</button>
        </div>
    );
}
